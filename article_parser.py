...
from constants import ARTICLES_PATH, DATA_RAW_PATH
...
#scrape all articles from the file generated by tag_search_parser.py
#provide a starter article to skip all articles before it - useful if you want to resume parsing after an error
def parse_and_save_articles(filename : str, starter : str = None):
  with open(ARTICLES_PATH + filename, "r") as input_file:
  ...
  with jsonlines.open(DATA_RAW_PATH + filename, "a") as writer:
